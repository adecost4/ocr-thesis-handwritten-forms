...
This is the primary research paper for Week 1 and serves as the foundation for understanding modern Transformer-based handwritten text recognition. The paper contrasts traditional CNN/RNN-based OCR systems with a pretrained Vision Transformer encoder and Transformer decoder architecture.
...
- Understand the motivation behind TrOCR.
- Learn why Transformer-based architectures outperform traditional CNN/RNN-based OCR models.
- Build a strong theoretical foundation before studying the model architecture in detail.

#### Important Resources

- Microsoft Research: https://www.microsoft.com/en-us/research/publication/trocr-transformer-based-optical-character-recognition-with-pre-trained-models/?utm_source=chatgpt.com&lang=fr-ca
- Official GitHub Repository: https://github.com/microsoft/unilm/tree/master/trocr
- Research Paper (arXiv): https://arxiv.org/pdf/2109.10282

#### Next Steps

- Continue reading the TrOCR paper (Model Architecture and Methodology).
- Take detailed notes on the Vision Transformer encoder and Transformer decoder.
- Relate the architecture to previous concepts learned (CNN, RNN, LSTM, and Transformer).
